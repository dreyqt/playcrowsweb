...
type PublicResult = { discord_id:string; event_type:EventType; public_status:'for_review'|'pending'|'processed'|'rejected'; review_note:string|null }
