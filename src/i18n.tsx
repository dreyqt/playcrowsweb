...
const en = {
  ...
  v2EventBonusTitle: "Current V2 Bonus · EVENT001 / EVENT002 / EVENT003 Rewards",
  v2EventBonusSummary: "Every $100 donation = choose 1 reward bundle: EVENT001, EVENT002, or EVENT003.",
  v2EventBonusRepeatable: "Repeatable: every additional $100 earns another reward bundle choice. $100 = 1, $200 = 2, $500 = 5.",
  v2EventBonusChoiceHint: "For each $100 reward bundle, you may choose the EVENT001, EVENT002, or EVENT003 reward bundle.",
  ...
  v2EventBonusNote: "EVENT001, EVENT002, and EVENT003 are available as V2 donation bonus options. V1 Heroic Skills and other V1 bonus events do not apply to V2.",
...
const ko: TranslationTable = {
  ...en,
  v2EventBonusTitle: "현재 V2 보너스 · EVENT001 / EVENT002 / EVENT003 보상",
  v2EventBonusSummary: "$100 후원마다 EVENT001, EVENT002 또는 EVENT003 보상 패키지 중 1개를 선택할 수 있습니다.",
  v2EventBonusRepeatable: "반복 획득 가능: 추가 $100마다 보상 패키지 선택권이 1회씩 추가됩니다. $100 = 1개, $200 = 2개, $500 = 5개.",
  v2EventBonusChoiceHint: "$100 보상 패키지마다 EVENT001, EVENT002 또는 EVENT003 보상 중 하나를 선택할 수 있습니다.",
  ...
  v2EventBonusNote: "EVENT001, EVENT002, EVENT003 모두 V2 후원 보너스 옵션으로 선택할 수 있습니다. V1 영웅 스킬 및 기타 V1 보너스 이벤트는 V2에 적용되지 않습니다.",
...
const th: TranslationTable = {
  ...en,
  v2EventBonusTitle: "โบนัส V2 ปัจจุบัน · รางวัล EVENT001 / EVENT002 / EVENT003",
  v2EventBonusSummary: "ทุกการสนับสนุน $100 = เลือกชุดรางวัล EVENT001, EVENT002 หรือ EVENT003 ได้ 1 ชุด",
  ...
  v2EventBonusChoiceHint: "สำหรับทุกชุดรางวัลจากยอดสนับสนุน $100 คุณสามารถเลือกชุดรางวัล EVENT001, EVENT002 หรือ EVENT003 ได้",
  ...
  v2EventBonusNote: "EVENT001, EVENT002 และ EVENT003 สามารถเลือกเป็นโบนัสการสนับสนุน V2 ได้ โบนัส Heroic Skills และโบนัสอื่นของ V1 ไม่มีผลกับ V2",
...
const pt: TranslationTable = {
  ...en,
  v2EventBonusTitle: "Bônus V2 Atual · Recompensas EVENT001 / EVENT002 / EVENT003",
  v2EventBonusSummary: "Cada doação de $100 = escolha 1 pacote de recompensas: EVENT001, EVENT002 ou EVENT003.",
  v2EventBonusRepeatable: "Repetível: a cada $100 adicionais, você recebe outra escolha de pacote. $100 = 1, $200 = 2, $500 = 5.",
  v2EventBonusChoiceHint: "Para cada pacote de recompensa de $100, você pode escolher o pacote do EVENT001, EVENT002 ou EVENT003.",
  ...
  v2EventBonusNote: "EVENT001, EVENT002 e EVENT003 estão disponíveis como opções de bônus de doação do V2. Heroic Skills e outros bônus do V1 não se aplicam ao V2.",
...
const zhTW: TranslationTable = {
  ...en,
  v2EventBonusTitle: "目前 V2 加碼 · EVENT001 / EVENT002 / EVENT003 獎勵",
  v2EventBonusSummary: "每贊助 $100 = 可從 EVENT001、EVENT002 或 EVENT003 中選擇 1 份獎勵組合。",
  v2EventBonusRepeatable: "可重複獲得：每增加 $100 可再獲得 1 次獎勵選擇。$100 = 1 份、$200 = 2 份、$500 = 5 份。",
  v2EventBonusChoiceHint: "每一份 $100 贊助獎勵都可選擇 EVENT001、EVENT002 或 EVENT003 獎勵組合。",
  v2EventBonusBundle: "選項 1 · EVENT001 獎勵組合",
  v2EventBonusBundle002: "選項 2 · EVENT002 獎勵組合",
  v2EventBonusBundle003: "選項 3 · EVENT003 獎勵組合",
  v2EventBonusNote: "EVENT001、EVENT002 與 EVENT003 均可作為 V2 贊助加碼選項。V1 英雄技能與其他 V1 加碼活動不適用於 V2。",
...
const ru: TranslationTable = {
  ...en,
  v2EventBonusTitle: "Текущий бонус V2 · Награды EVENT001 / EVENT002 / EVENT003",
  v2EventBonusSummary: "За каждые $100 пожертвования можно выбрать 1 комплект наград: EVENT001, EVENT002 или EVENT003.",
  ...
  v2EventBonusChoiceHint: "Для каждого бонусного комплекта за $100 можно выбрать награды EVENT001, EVENT002 или EVENT003.",
  ...
  v2EventBonusNote: "EVENT001, EVENT002 и EVENT003 доступны как варианты бонуса за пожертвования V2. Heroic Skills и другие бонусы V1 не применяются к V2.",
