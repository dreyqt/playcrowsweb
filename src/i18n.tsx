...
export type LanguageCode = 'en' | 'ko' | 'th' | 'pt' | 'zh-TW'
...
const en = {
  ...
  voluntaryFooter: '2026 PlayCrows Development Team - All contributions are voluntary support donations.',
...
const ko: TranslationTable = {
  ...
  currency: '재화', supportPackages: '지원 패키지', currencyDesc: 'WEB 상점에서 이용 가능한 다이아 패키지입니다.', supportPackagesDesc: '직접 후원을 위한 아이템 번들입니다.', webShopIntro: '아래 카테고리를 선택해 원하는 패키지를 빠르게 확인하세요.', supportPackage: '지원 패키지', selected: '선택됨', select: '선택', packageContinueNotice: '계속하려면 패키지를 선택하세요. 귀속 아이템은 거래하거나 이전할 수 없습니다.',
...
const th: TranslationTable = {
  ...
  currency: 'สกุลเงิน', supportPackages: 'แพ็กเกจสนับสนุน', currencyDesc: 'แพ็กเกจ Diamond ที่มีใน WEB Shop', supportPackagesDesc: 'ชุดไอเทมสำหรับการสนับสนุนโดยตรง', webShopIntro: 'เลือกหมวดหมู่ด้านล่างเพื่อค้นหาแพ็กเกจได้ง่ายขึ้น', supportPackage: 'แพ็กเกจสนับสนุน', selected: 'เลือกแล้ว', select: 'เลือก', packageContinueNotice: 'เลือกแพ็กเกจเพื่อดำเนินการต่อ ไอเทม Bound ไม่สามารถซื้อขายหรือโอนได้',
