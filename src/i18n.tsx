...
const en = {
  ...
  promoEnded: 'The V2EARLY10 promotion ended on September 9, 2026 at 12:00 PM GMT+8.',
  invalidRedeem: 'Invalid redeem code.',
  promoNotEligible: 'V2EARLY10 applies to V2 Diamond Packages during the early top-up period.',
  promoApplied: 'V2EARLY10 applied. You will pay 10% less while receiving the full V2 Diamond Package rewards.',
  promoExpiredReview: 'The V2EARLY10 promotion has expired. Review the regular payment amount before submitting.',
  ...
  pay: 'Pay',
  receiveFullPackage: 'and receive the full V2 Diamond Package rewards.',
...
const ko: TranslationTable = {
  ...
  promoEnded: en.promoEnded, invalidRedeem: '유효하지 않은 프로모션 코드입니다.', promoNotEligible: 'V2EARLY10은 대상 패키지에만 적용됩니다.', promoApplied: 'V2EARLY10이 적용되었습니다. 결제 금액은 10% 할인되며 V2 다이아몬드 패키지의 전체 보상을 받습니다.', promoExpiredReview: 'V2EARLY10 프로모션이 종료되었습니다. 제출 전에 일반 결제 금액을 확인하세요.', unableSubmit: '후원 신청을 제출할 수 없습니다. 다시 시도해 주세요.', missingIcon: '아이콘 없음', iconUnavailable: '아이콘을 사용할 수 없음', viewRewards: '보상 보기', close: '닫기',
}
...
const ru: TranslationTable = {
  ...
  promoEnded: 'Акция V2EARLY10 завершилась 9 сентября 2026 года в 12:00 по сингапурскому времени.',
  invalidRedeem: 'Неверный промокод.',
  promoNotEligible: 'V2EARLY10 действует только для подходящих подарочных пакетов.',
  promoApplied: 'V2EARLY10 применён. Вы заплатите на 10% меньше и получите все награды V2 Diamond Package.',
  promoExpiredReview: 'Акция V2EARLY10 завершилась. Проверьте обычную сумму оплаты перед отправкой.',
  ...
  pay: 'Оплатить',
  receiveFullPackage: 'и получить все награды V2 Diamond Package.',
