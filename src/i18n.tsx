...
const en = {
  ...
  v2EventBonusTitle: "Current V2 Bonus · EVENT001 / EVENT002 / EVENT003 / EVENT004 / EVENT005 Rewards",
  v2EventBonusSummary: "Every $100 donation = choose 1 reward bundle: EVENT001, EVENT002, EVENT003, EVENT004, or EVENT005.",
  v2EventBonusRepeatable: "Repeatable: every additional $100 earns another reward bundle choice. $100 = 1, $200 = 2, $500 = 5.",
  v2EventBonusChoiceHint: "For each $100 reward bundle, you may choose the EVENT001, EVENT002, EVENT003, EVENT004, or EVENT005 reward bundle.",
  v2EventBonusBundle: "OPTION 1 · EVENT001 Reward Bundle",
  v2EventBonusBundle002: "OPTION 2 · EVENT002 Reward Bundle",
  v2EventBonusBundle003: "OPTION 3 · EVENT003 Reward Bundle",
  v2EventBonusBundle004: "OPTION 4 · EVENT004 Reward Bundle",
  v2EventBonusBundle005: "OPTION 5 · EVENT005 Reward Bundle",
  v2EventBonusNote: "EVENT001, EVENT002, EVENT003, EVENT004, and EVENT005 are available as V2 donation bonus options. V1 Heroic Skills and other V1 bonus events do not apply to V2.",
  v2EventBonusViewEvent: "View V2 event details",
  ...
  promoEnded: 'The WEEKEND10 promotion ended on September 20, 2026 at 11:59 PM GMT+8.',
  invalidRedeem: 'Invalid redeem code.',
  promoNotEligible: 'WEEKEND10 applies to eligible V1 and V2 Web Shop packages during the weekend promotion.',
  promoApplied: 'WEEKEND10 applied. You will pay 10% less while receiving the full selected package rewards.',
  ...
  pay: 'Pay',
  receiveFullPackage: 'and receive the full selected package rewards.',
  redeemRemoved: 'Redeem code removed.',
  earlyPromotionEnded: 'The weekend promotion has ended.',
...
const ko: TranslationTable = {
  ...en,
  v2EventBonusTitle: "현재 V2 보너스 · EVENT001 / EVENT002 / EVENT003 / EVENT004 / EVENT005 보상",
  v2EventBonusSummary: "$100 후원마다 EVENT001, EVENT002, EVENT003, EVENT004 또는 EVENT005 보상 패키지 중 1개를 선택할 수 있습니다.",
  v2EventBonusRepeatable: "반복 획득 가능: 추가 $100마다 보상 패키지 선택권이 1회씩 추가됩니다. $100 = 1개, $200 = 2개, $500 = 5개.",
  v2EventBonusChoiceHint: "$100 보상 패키지마다 EVENT001, EVENT002, EVENT003, EVENT004 또는 EVENT005 보상 중 하나를 선택할 수 있습니다.",
  v2EventBonusBundle: "옵션 1 · EVENT001 보상 패키지",
  v2EventBonusBundle002: "옵션 2 · EVENT002 보상 패키지",
  v2EventBonusBundle003: "옵션 3 · EVENT003 보상 패키지",
  v2EventBonusBundle004: "옵션 4 · EVENT004 보상 패키지",
  v2EventBonusBundle005: "옵션 5 · EVENT005 보상 패키지",
  v2EventBonusNote: "EVENT001, EVENT002, EVENT003, EVENT004, EVENT005 모두 V2 후원 보너스 옵션으로 선택할 수 있습니다. V1 영웅 스킬 및 기타 V1 보너스 이벤트는 V2에 적용되지 않습니다.",
  v2EventBonusViewEvent: "V2 이벤트 자세히 보기",
  ...
  promoEnded: en.promoEnded, invalidRedeem: '유효하지 않은 프로모션 코드입니다.', promoNotEligible: 'WEEKEND10은 프로모션 기간 동안 V1 및 V2 WEB 상점의 대상 패키지에 적용됩니다.', promoApplied: 'WEEKEND10이 적용되었습니다. 결제 금액은 10% 할인되며 선택한 패키지의 전체 보상을 받습니다.', promoExpiredReview: 'WEEKEND10 프로모션이 종료되었습니다. 제출 전에 일반 결제 금액을 확인하세요.', unableSubmit: '후원 신청을 제출할 수 없습니다. 다시 시도해 주세요.', missingIcon: '아이콘 없음', iconUnavailable: '아이콘을 사용할 수 없음', viewRewards: '보상 보기', close: '닫기',
}

const th: TranslationTable = {
  ...en,
  v2EventBonusTitle: "โบนัส V2 ปัจจุบัน · รางวัล EVENT001 / EVENT002 / EVENT003 / EVENT004 / EVENT005",
  v2EventBonusSummary: "ทุกการสนับสนุน $100 = เลือกชุดรางวัล EVENT001, EVENT002, EVENT003, EVENT004 หรือ EVENT005 ได้ 1 ชุด",
  v2EventBonusRepeatable: "รับซ้ำได้: ทุก ๆ $100 เพิ่มเติมจะได้รับสิทธิ์เลือกชุดรางวัลเพิ่มอีก 1 ชุด $100 = 1 ชุด, $200 = 2 ชุด, $500 = 5 ชุด",
  v2EventBonusChoiceHint: "สำหรับทุกชุดรางวัลจากยอดสนับสนุน $100 คุณสามารถเลือกชุดรางวัล EVENT001, EVENT002, EVENT003, EVENT004 หรือ EVENT005 ได้",
  v2EventBonusBundle: "ตัวเลือก 1 · ชุดรางวัล EVENT001",
  v2EventBonusBundle002: "ตัวเลือก 2 · ชุดรางวัล EVENT002",
  v2EventBonusBundle003: "ตัวเลือก 3 · ชุดรางวัล EVENT003",
  v2EventBonusBundle004: "ตัวเลือก 4 · ชุดรางวัล EVENT004",
  v2EventBonusBundle005: "ตัวเลือก 5 · ชุดรางวัล EVENT005",
  v2EventBonusNote: "EVENT001, EVENT002, EVENT003, EVENT004 และ EVENT005 สามารถเลือกเป็นโบนัสการสนับสนุน V2 ได้ โบนัส Heroic Skills และโบนัสอื่นของ V1 ไม่มีผลกับ V2",
  v2EventBonusViewEvent: "ดูรายละเอียดกิจกรรม V2",
...
const ru: TranslationTable = {
  ...
  promoEnded: 'Акция WEEKEND10 завершилась 20 сентября 2026 года в 23:59 по GMT+8.',
  invalidRedeem: 'Неверный промокод.',
  promoNotEligible: 'WEEKEND10 действует на подходящие пакеты WEB Shop V1 и V2 во время акции выходного дня.',
  promoApplied: 'WEEKEND10 применён. Вы заплатите на 10% меньше и получите полный набор наград выбранного пакета.',
  ...
  pay: 'Оплатить',
  receiveFullPackage: 'и получить полный набор наград выбранного пакета.',
  redeemRemoved: 'Промокод удалён.',
  earlyPromotionEnded: 'Акция WEEKEND10 завершилась.',
