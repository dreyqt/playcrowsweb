...
const en = {
  ...
  v2EventBonusTitle: "Current V2 Bonus · EVENT001 Rewards",
  v2EventBonusSummary: "Every $100 donation = 1 EVENT001 reward bundle.",
  v2EventBonusRepeatable: "Repeatable: every additional $100 earns another reward bundle. $100 = 1, $200 = 2, $500 = 5.",
  v2EventBonusBundle: "EVENT001 Reward Bundle",
  v2EventBonusNote: "This is the current V2 donation bonus. V1 Heroic Skills and other V1 bonus events do not apply to V2.",
  v2EventBonusViewEvent: "View EVENT001 details",
...
const ko: TranslationTable = {
  ...en,
  v2EventBonusTitle: "현재 V2 보너스 · EVENT001 보상",
  v2EventBonusSummary: "$100 후원마다 EVENT001 보상 패키지 1개를 획득할 수 있습니다.",
  v2EventBonusRepeatable: "반복 획득 가능: 추가 $100마다 보상 패키지 1개가 추가됩니다. $100 = 1개, $200 = 2개, $500 = 5개.",
  v2EventBonusBundle: "EVENT001 보상 패키지",
  v2EventBonusNote: "현재 V2에 적용되는 후원 보너스입니다. V1 영웅 스킬 및 기타 V1 보너스 이벤트는 V2에 적용되지 않습니다.",
  v2EventBonusViewEvent: "EVENT001 자세히 보기",
...
const th: TranslationTable = {
  ...en,
  v2EventBonusTitle: "โบนัส V2 ปัจจุบัน · รางวัล EVENT001",
  v2EventBonusSummary: "ทุกการสนับสนุน $100 = ชุดรางวัล EVENT001 1 ชุด",
  v2EventBonusRepeatable: "รับซ้ำได้: ทุก ๆ $100 เพิ่มเติมจะได้รับอีก 1 ชุดรางวัล $100 = 1 ชุด, $200 = 2 ชุด, $500 = 5 ชุด",
  v2EventBonusBundle: "ชุดรางวัล EVENT001",
  v2EventBonusNote: "นี่คือโบนัสการสนับสนุน V2 ในปัจจุบัน โบนัส Heroic Skills และโบนัสอื่นของ V1 ไม่มีผลกับ V2",
  v2EventBonusViewEvent: "ดูรายละเอียด EVENT001",
...
const pt: TranslationTable = {
  ...en,
  v2EventBonusTitle: "Bônus V2 Atual · Recompensas EVENT001",
  v2EventBonusSummary: "Cada doação de $100 = 1 pacote de recompensas do EVENT001.",
  v2EventBonusRepeatable: "Repetível: a cada $100 adicionais, você recebe outro pacote. $100 = 1, $200 = 2, $500 = 5.",
  v2EventBonusBundle: "Pacote de Recompensas EVENT001",
  v2EventBonusNote: "Este é o bônus de doação atual do V2. Heroic Skills e outros bônus do V1 não se aplicam ao V2.",
  v2EventBonusViewEvent: "Ver detalhes do EVENT001",
...
const zhTW: TranslationTable = {
  ...en,
  v2EventBonusTitle: "目前 V2 加碼 · EVENT001 獎勵",
  v2EventBonusSummary: "每贊助 $100 = 1 份 EVENT001 獎勵組合。",
  v2EventBonusRepeatable: "可重複獲得：每增加 $100 可再獲得 1 份。$100 = 1 份、$200 = 2 份、$500 = 5 份。",
  v2EventBonusBundle: "EVENT001 獎勵組合",
  v2EventBonusNote: "這是目前 V2 的贊助加碼。V1 英雄技能與其他 V1 加碼活動不適用於 V2。",
  v2EventBonusViewEvent: "查看 EVENT001 詳情",
...
const ru: TranslationTable = {
  ...en,
  v2EventBonusTitle: "Текущий бонус V2 · Награды EVENT001",
  v2EventBonusSummary: "Каждые $100 пожертвования = 1 комплект наград EVENT001.",
  v2EventBonusRepeatable: "Можно получать повторно: за каждые дополнительные $100 начисляется ещё 1 комплект. $100 = 1, $200 = 2, $500 = 5.",
  v2EventBonusBundle: "Комплект наград EVENT001",
  v2EventBonusNote: "Это текущий бонус за пожертвования в V2. Heroic Skills и другие бонусы V1 не применяются к V2.",
  v2EventBonusViewEvent: "Подробнее об EVENT001",
