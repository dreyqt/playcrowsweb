...
const en = {
  ...
  promoEnded: 'The WEEKEND10 promotion ended on August 30, 2026 at 11:59 PM GMT+8.',
  invalidRedeem: 'Invalid redeem code.',
  promoNotEligible: 'WEEKEND10 applies to preset gift packages on non-PayPal payment methods.',
  promoApplied: 'WEEKEND10 applied. You will pay 10% less while receiving the full package and cumulative credit.',
  promoExpiredReview: 'The WEEKEND10 promotion has expired. Review the regular payment amount before submitting.',
...
const ko: TranslationTable = {
  ...
  promoEnded: en.promoEnded, invalidRedeem: '유효하지 않은 프로모션 코드입니다.', promoNotEligible: 'WEEKEND10은 대상 패키지에만 적용됩니다.', promoApplied: 'WEEKEND10이 적용되었습니다. 전체 패키지와 누적 크레딧은 유지되며 결제 금액은 10% 할인됩니다.', promoExpiredReview: 'WEEKEND10 프로모션이 종료되었습니다. 제출 전에 일반 결제 금액을 확인하세요.', unableSubmit: '후원 신청을 제출할 수 없습니다. 다시 시도해 주세요.', missingIcon: '아이콘 없음', iconUnavailable: '아이콘을 사용할 수 없음', viewRewards: '보상 보기', close: '닫기',
}
...
const ru: TranslationTable = {
  ...
  promoEnded: 'Акция WEEKEND10 завершилась 31 июля 2026 года в 15:00 по сингапурскому времени.',
  invalidRedeem: 'Неверный промокод.',
  promoNotEligible: 'WEEKEND10 действует только для подходящих подарочных пакетов.',
  promoApplied: 'WEEKEND10 применён. Вы заплатите на 10% меньше и получите полный пакет и накопительный кредит.',
  promoExpiredReview: 'Акция WEEKEND10 завершилась. Проверьте обычную сумму оплаты перед отправкой.',
